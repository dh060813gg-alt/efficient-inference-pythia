...
def builtin_texts() -> list[str]:
    return [
        "Natural language processing studies how computers understand and generate human language. Efficient inference is important because modern language models spend most of their memory on cached attention keys and values during long-context generation.",
        "A practical inference system should report both quality and latency. Perplexity measures language modeling quality, while time to first token, time per output token, and throughput describe user-visible speed.",
        "Key value cache compression keeps a smaller subset of previous tokens. Recent tokens are often important for local coherence, while high-attention tokens preserve salient global information.",
    ]


def load_local_texts(path: str | None) -> list[str] | None:
    if path is None:
        return None
    file_path = Path(path)
...
def load_dataset_texts(dataset_name: str, split: str, max_samples: int) -> list[str]:
    if dataset_name == "pg19":
        return _load_pg19_raw(max_samples)
    try:
        from datasets import load_dataset
    except ImportError as exc:
        raise RuntimeError("Install datasets to load remote benchmark data.") from exc
    ...
    for row in dataset:
        ...
        if len(texts) >= max_samples:
            break
    if not texts:
        raise RuntimeError(f"No non-empty text was found in {dataset_name}:{split}.")
    return texts


def _load_pg19_raw(max_samples: int) -> list[str]:
    import warnings

    warnings.warn(
        "PG-19 dataset is not available (datasets library no longer supports "
        "its script format and GCS URLs are inaccessible). "
        "Using a built-in long text as a substitute for long-context evaluation.",
        RuntimeWarning,
    )
    return [_PG19_FALLBACK_TEXT]
...
_PG19_FALLBACK_TEXT = (
    ...
    "Do not you want to know who has taken it? cried his wife impatiently. You want to tell me, and I have no objection to hearing it. This was invitation enough. Why, my dear, you must know, Mrs. Long says that Netherfield is taken by a young man of large fortune from the north of England. "
    ...
    "What is his name? Bingley. Is he married or single? Oh, single, my dear, to be sure! A single man of large fortune, four or five thousand a year. What a fine thing for our girls! How so? how can it affect them? My dear Mr. Bennet, replied his wife, how can you be so tiresome! "
    "You must know that I am thinking of his marrying one of them. Is that his design in settling here? Design! nonsense, how can you talk so! But it is very likely that he may fall in love with one of them, and therefore you must visit him as soon as he comes. "
    ...
    "When a woman has five grown up daughters, she ought to give over thinking of her own beauty. In such cases a woman has not often much beauty to think of. But, my dear, you must indeed go and see Mr. Bingley when he comes into the neighbourhood. It is more than I engage for, I assure you. "
    "But consider your daughters. Only think what an establishment it would be for one of them. Sir William and Lady Lucas are determined to go, merely on that account, for in general you know they visit no new comers. Indeed you must go, for it will be impossible for us to visit him if you do not. "
    "You are over scrupulous surely. I dare say Mr. Bingley will be very glad to see you, and I will send a few lines by you to assure him of my hearty consent to his marrying whichever he chooses of the girls, though I must throw in a good word for my little Lizzy. "
    "I desire you will do no such thing. Lizzy is not a bit better than the others, and I am sure she is not half so handsome as Jane, nor half so good humoured as Lydia. But you are always giving her the preference. They have none of them much to recommend them, replied he. "
    "They are all silly and ignorant like other girls, but Lizzy has something more of quickness than her sisters. Mr. Bennet, how can you abuse your own children in such a way? You take delight in vexing me. You have no compassion on my poor nerves. "
    ...
    "It was then disclosed in the following manner. Observing his second daughter employed in trimming a hat, he suddenly addressed her with, I hope Mr. Bingley will like it, Lizzy. We are not in a way to know what Mr. Bingley likes, said her mother resentfully, since we are not to visit. "
    "But you forget, mamma, said Elizabeth, that we shall meet him at the assemblies, and that Mrs. Long has promised to introduce him. I do not believe Mrs. Long will do any such thing. She has two nieces of her own. She is a selfish, hypocritical woman, and I have no opinion of her. "
    "No more have I, said Mr. Bennet, and I am glad to find that you do not depend on her serving you. Mrs. Bennet deigned not to make any reply, but unable to contain herself began scolding one of her daughters. "
    "Do not keep coughing so, Kitty, for Heaven's sake! Have a little compassion on my nerves. You tear them to pieces. Kitty has no discretion in her coughs, said her father, she times them ill. I do not cough for my own amusement, replied Kitty fretfully. When is your next ball to be, Lizzy? "
    "To-morrow fortnight. Aye, so it is, cried her mother, and Mrs. Long does not come back till the day before, so it will be impossible for her to introduce him, for she will not know him herself. Then, my dear, you may have the advantage of your friend, and introduce Mr. Bingley to her. "
    "Impossible, Mr. Bennet, impossible, when I am not acquainted with him myself. How can you be so teasing? I honour your circumspection. A fortnight's acquaintance is certainly very little. One cannot know what a man really is by the end of a fortnight. "
    "But if we do not venture, somebody else will, and after all Mrs. Long and her nieces must stand their chance, and therefore, as she will think it an act of kindness if you decline the office, I will take it on myself. The girls stared at their father. Mrs. Bennet said only, Nonsense, nonsense! "
    "What can be the meaning of that emphatic exclamation? cried he. Do you consider the forms of introduction, and the stress that is laid on them, as nonsense? I cannot quite agree with you there. What say you, Mary? For you are a young lady of deep reflection, I know, and read great books and make extracts. "
    "Mary wished to say something very sensible, but knew not how. While Mary is adjusting her ideas, he continued, let us return to Mr. Bingley. I am sick of Mr. Bingley, cried his wife. I am sorry to hear that, but why did not you tell me so before? If I had known as much this morning I certainly would not have called on him. "
    ...
    "At our time of life it is not so pleasant, I can tell you, to be making new acquaintance every day, but for your sakes we would do any thing. Lydia, my love, though you are the youngest, I dare say Mr. Bingley will dance with you at the next ball. Oh, said Lydia stoutly, I am not afraid, for though I am the youngest, I am the tallest. "
    ...
    "If I can but see one of my daughters happily settled at Netherfield, said Mrs. Bennet to her husband, and all the others equally well married, I shall have nothing to wish for. In a few days Mr. Bingley returned Mr. Bennet's visit, and sat about ten minutes with him in his library. "
    ...
    "Not all his large estate in Derbyshire could then save him from having a most forbidding disagreeable countenance, and being unworthy to be compared with his friend. Mr. Bingley had soon made himself acquainted with all the principal people in the room. He was lively and unreserved, danced every dance, was angry that the ball closed so early, and talked of giving one himself at Netherfield. "
    ...
    "She told the story however with great spirit among her friends, for she had a lively playful disposition which delighted in any thing ridiculous. The evening altogether passed off pleasantly to the whole family. Mrs. Bennet had seen her eldest daughter much admired by the Netherfield party. "
    "Mr. Bingley had danced with her twice, and she had been distinguished by his sisters. Jane was as much gratified by this as her mother could be, though in a quieter way. Elizabeth felt Jane's pleasure. Mary had heard herself mentioned to Miss Bingley as the most accomplished girl in the neighbourhood, and Catherine and Lydia had been fortunate enough never to be without partners, which was all that they had yet learnt to care for at a ball. "
    ...
    "Every body said how well she looked, and Mr. Bingley thought her quite beautiful, and danced with her twice. Only think of that, my dear, he actually danced with her twice, and she was the only creature in the room that he asked a second time. First of all he asked Miss Lucas. I was so vexed to see him stand up with her, but however he did not admire her at all. "
    ...
    "He is also handsome, replied Elizabeth, which a young man ought likewise to be if he possibly can. His character is thereby complete. I was very much flattered by his asking me to dance a second time. I did not expect such a compliment. Did not you? I did for you. But that is one great difference between us. "
    ...
    "In that respect his friend had greatly the advantage. Bingley was sure of being liked wherever he appeared, Darcy was continually giving offence. The manner in which they spoke of the Meryton assembly was sufficiently characteristic. Bingley had never met with pleasanter people or prettier girls in his life. "
    "Every body had been most kind and attentive to him, there had been no formality, no stiffness, he had soon felt acquainted with all the room, and as to Miss Bennet, he could not conceive an angel more beautiful. Darcy, on the contrary, had seen a collection of people in whom there was little beauty and no fashion, for none of whom he had felt the smallest interest, and from none received either attention or pleasure. "
...
def iter_token_windows(input_ids, max_length: int, stride: int) -> Iterable:
